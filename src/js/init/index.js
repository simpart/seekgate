...
try {
    ...
    root_cmp.visible(true,() => {try{
        ...
        /* script (after) */
        class Thermo{constructor(t){try{if("number"!=typeof t)throw new Error("invalid parameter");this.m_threshold=t,this.m_status="none"}catch(t){throw console.error(t.stack),t}}start(){try{this.m_wsock=new WebSocket("ws:/"+location.host+":5000","thermo");let t=this,r=!1;this.m_wsock.addEventListener("open",e=>{r=!0,t.wsk_callback()(!0)}),this.m_wsock.addEventListener("close",r=>{t.wsk_callback()(!1)}),setTimeout(()=>{!1===r&&alert("failed connect to thermo camera")},5e3),this.m_wsock.addEventListener("message",r=>{if(""===r.data)return;let e=JSON.parse(r.data);t.inf_event()(e);let o=null;o=this.m_threshold-1.5>e.temperature?"none":this.m_threshold>e.temperature?"pass":"alert",this.m_status!==o&&(this.m_status=o,t.sts_event()(o))})}catch(t){throw console.error(t.stack),t}}wsk_callback(t){try{if(void 0===t){if(void 0===this.m_wskcb)throw new Error("could not find callback");return this.m_wskcb}if("function"!=typeof t)throw new Error("invalid parameter");this.m_wskcb=t}catch(t){throw console.error(t.stack),t}}inf_event(t){try{if(void 0===t){if(void 0===this.m_infcb)throw new Error("could not find event");return this.m_infcb}if("function"!=typeof t)throw new Error("invalid parameter");this.m_infcb=t}catch(t){throw console.error(t.stack),t}}sts_event(t){try{if(void 0===t){if(void 0===this.m_stscb)throw new Error("could not find event");return this.m_stscb}if("function"!=typeof t)throw new Error("invalid parameter");this.m_stscb=t}catch(t){throw console.error(t.stack),t}}}
        let thm_prs = () => {
            try {
